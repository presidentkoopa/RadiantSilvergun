	...
	override void RollStats(EVR_Tier t)
	{
		...
		switch (t)
		{
			case VRT_Basic:
				...
				Velocity      = RS_Roll.RollDouble(32, 48);
			...
			case VRT_Advanced:
				...
				Velocity      = RS_Roll.RollDouble(32, 52);
			...
			case VRT_Designer:
				...
				Velocity      = RS_Roll.RollDouble(32, 56);
			...
			case VRT_Prototype:
				...
				Velocity      = RS_Roll.RollDouble(32, 60);
			...
			case VRT_Trash:
				...
				Velocity = RS_Roll.RollDouble(28, 44);
				Capacity = 2;
				break;
			case VRT_Cursed:
