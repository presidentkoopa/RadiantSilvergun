// RS_GH_HandGrenade -- GunstarHeroes set, imported from the source arsenal pack.
// ---------------------------------------------------------------------
// Taken from the source: sprites (HBHG), the model and its real frame
...
// =====================================================================
class RS_GH_HandGrenade : RS_Weapon
{
	Default
	{
		Tag "Gunstar Hand Grenade";
		Weapon.SelectionOrder 1340;
		Weapon.SlotNumber 5;
		Weapon.AmmoUse 0;
		Weapon.AmmoGive1 0;
		Weapon.AmmoType1 "RocketAmmo";
		Inventory.Icon "HBHGA0";
		+WEAPON.NOHANDSWITCH;
	}
	...
	// midpoint, with tiers ramping from it, so a GH HandGrenade is a rolled weapon
	...
	Ready:
		HBHG A 1 A_WeaponReady(WRF_ALLOWRELOAD);
...
class RS_GH_HandGrenade2 : RS_GH_HandGrenade
{
	Default
	{
		Tag "Gunstar Hand Grenade II";
		Weapon.SelectionOrder 1339;
	}
}

class RS_GH_HandGrenade3 : RS_GH_HandGrenade
{
	Default
	{
		Tag "Gunstar Hand Grenade III";
		Weapon.SelectionOrder 1338;
	}
}

class RS_GH_HandGrenade4 : RS_GH_HandGrenade
{
	Default
	{
		Tag "Gunstar Hand Grenade IV";
		Weapon.SelectionOrder 1337;
		+WEAPON.OFFHANDWEAPON;
	}
}

class RS_GH_HandGrenade5 : RS_GH_HandGrenade
{
	Default
	{
		Tag "Gunstar Hand Grenade V";
		Weapon.SelectionOrder 1336;
		+WEAPON.OFFHANDWEAPON;
	}
}

class RS_GH_HandGrenade6 : RS_GH_HandGrenade
{
	Default
	{
		Tag "Gunstar Hand Grenade VI";
