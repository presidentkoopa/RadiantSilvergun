// RS_GH_Flamethrower -- GunstarHeroes set, imported from the source arsenal pack.
// ---------------------------------------------------------------------
// Taken from the source: sprites (HBFT), the model and its real frame
// indices (see MODELDEF -- copied verbatim from the pack's own
// modeldef.vr_hb_weapons, nothing inferred), the fire sound, and the
// weapon's SHAPE: slot 7, ballistic, 1 pellet(s), 7.0 degree cone,
// fireDelay 2 (~17 shots/sec).
//
...
// =====================================================================
class RS_GH_Flamethrower : RS_Weapon
{
	Default
	{
		Tag "Gunstar Flamethrower";
		Weapon.SelectionOrder 1855;
		Weapon.SlotNumber 7;
		Weapon.AmmoUse 0;
		Weapon.AmmoGive1 0;
		Weapon.AmmoType1 "Cell";
		Inventory.Icon "HBFTA0";
		+WEAPON.NOHANDSWITCH;
	}
	...
	// midpoint, with tiers ramping from it, so a GH Flamethrower is a rolled weapon
...
class RS_GH_Flamethrower2 : RS_GH_Flamethrower
{
	Default
	{
		Tag "Gunstar Flamethrower II";
		Weapon.SelectionOrder 1854;
	}
}

class RS_GH_Flamethrower3 : RS_GH_Flamethrower
{
	Default
	{
		Tag "Gunstar Flamethrower III";
		Weapon.SelectionOrder 1853;
	}
}

class RS_GH_Flamethrower4 : RS_GH_Flamethrower
{
	Default
	{
		Tag "Gunstar Flamethrower IV";
		Weapon.SelectionOrder 1852;
		+WEAPON.OFFHANDWEAPON;
	}
}

class RS_GH_Flamethrower5 : RS_GH_Flamethrower
{
	Default
	{
		Tag "Gunstar Flamethrower V";
		Weapon.SelectionOrder 1851;
		+WEAPON.OFFHANDWEAPON;
	}
}

class RS_GH_Flamethrower6 : RS_GH_Flamethrower
{
	Default
	{
		Tag "Gunstar Flamethrower VI";
