...
class RS_CasingSmall : RS_DebrisGeneral
{
	...
	{
	Spawn:
		TNT1 A 0 NoDelay A_StartSound("rs_fx_casing_pistol", CHAN_AUTO);
	Tumble:
		RSC0 "ABCDE" 2;
		Loop;
	Death:
...
class RS_CasingRifle : RS_CasingSmall
{
	...
	{
	Spawn:
		TNT1 A 0 NoDelay A_StartSound("rs_fx_casing_chaingun", CHAN_AUTO);
	Tumble:
		RSC1 "ABCDE" 2;
		Loop;
	}
...
class RS_CasingShell : RS_CasingSmall
{
	...
	{
	Spawn:
		TNT1 A 0 NoDelay A_StartSound("rs_fx_casing_shell", CHAN_AUTO);
	Tumble:
		RSC2 "ABDGK" 3;
		Loop;
	}
